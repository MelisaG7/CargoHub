...
JSON_DB_PATH = "data\transfers.json"
JSON_DB_BACKUP_PATH = "api\testing"


def backup_json_db():
    shutil.copy(JSON_DB_PATH, JSON_DB_BACKUP_PATH)


def restore_json_db():
    shutil.copy(JSON_DB_BACKUP_PATH, JSON_DB_PATH)
    os.remove(JSON_DB_BACKUP_PATH)
...
#     # Trying to delete a transfer as an user with limited access
#     # THE CODE IS 500 BECAUSE it doens't handle exceptions
