...
import json
import os
from models.item_lines import *

# Sample dummy data for tests
DUMMY_DATA = [
    {"id": 1, "name": "Home Appliances", "description": "", "created_at": "1979-01-16 07:07:50", "updated_at": "2024-01-05 23:53:25"},
    {"id": 2, "name": "Office Supplies", "description": "", "created_at": "2009-07-18 08:13:40", "updated_at": "2020-01-12 14:32:49"},
    {"id": 3, "name": "Fashion", "description": "", "created_at": "1990-01-04 22:40:49", "updated_at": "2003-05-17 08:21:43"}
]
...
def test_update_item_line():
    ...
    # item_lines = ItemLines(".data/", True)
    item_lines.data = DUMMY_DATA
    updated_item = {"id": 2, "name": "Updated Office Supplies", "description": "Updated description"}
