...
class TestItemGroups:
    ...
    def test_get_item_groups(self):
        ...
        assert result == self.item_groups.data[1]
    ...
    def test_add_item_group(self):
        ...
        assert self.item_groups.data.__len__() == 3
        empty_body = {}
        self.item_groups.add_item_group(empty_body)
        assert self.item_groups.data == 3
        incorrect_body = {
            "id": 5,
    ...
    def test_update_item_group(self):
        ...
        assert self.item_groups.data[1]["name"] == "Heels"
        ...
        assert self.item_groups.data[2]["id"] == 2
    
    def test_remove_item_group(self):
        self.item_groups.remove_item_group(1)
        assert self.item_groups.data.__len__() == 1
