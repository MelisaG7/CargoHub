...
def test_add_item_lines():
    ...
    response_user = httpx.post(f"{BASE_URL}/item_lines", headers=user_headers, json=data_user)
...
def test_update_item_lines():
    ...
    response_user = httpx.put(f"{BASE_URL}/item_lines/12", headers=user_headers, json=data_user)
